               ...
               if(userField.getText().toLowerCase().equals("admin"))        // Hardcoded user/password
                {
                    ...
                    else
                    {
                        ...
                        passwordAlert.setTitle("Wrong password");
                        passwordAlert.setHeaderText("Wrong password");
                        passwordAlert.setContentText("Check your username/password and try again");
                ...
                else
                {
                   ...
                   userNameAlert.setTitle("No such user");
                   userNameAlert.setHeaderText("No such user");
                   userNameAlert.setContentText("Check your username and try again");
